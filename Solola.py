...
# --- WEB UI ---
st.title("🇬🇹 MAGA: Procesador de Facturas por la LAE: Sololá")
...
MUNICIPIOS_OPCIONES = {
    ...
    "Nahualá": 2,
    "Panajachel": 3,
    "San Andrés Semetabaj": 4,
    "San Antonio Palopó": 5,
    "San José Chacayá": 6,
    "San Juan La Laguna": 7,
    "San Lucas Tolimán": 8,
    "San Marcos La Laguna": 9,
    "San Pablo La Laguna": 10,
    "San Pedro La Laguna": 11,
    "Santa Catarina Ixtahuacán": 12,
    "San Catarina Palopó": 13,
    "Santa Clara La Laguna": 14,
    "Santa Cruz La Laguna": 15,
    "Santa Lucía Utatlán": 16,
    "Santa Maria Visitacion": 17,
    "Santiago Atitlán": 18,
    "Sololá": 19
}
